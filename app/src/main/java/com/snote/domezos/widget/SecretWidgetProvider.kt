...
class SecretWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        ...
        fun updateWidget(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
            ...
            if (link == null) {
                configureIdleState(views, localizedContext, encryptPendingIntent)
            } else {
                configureResultState(views, context, localizedContext, appWidgetId, link, encryptPendingIntent)
            }

            appWidgetManager.updateAppWidget(appWidgetId, views)
        }

        private fun applyThemeColors(views: RemoteViews, theme: com.snote.domezos.ui.theme.AppThemeConfig) {
        ...
        private fun configureIdleState(views: RemoteViews, localizedContext: Context, encryptPendingIntent: PendingIntent) {
        ...
        private fun configureResultState(
            views: RemoteViews,
            context: Context,
            localizedContext: Context,
            appWidgetId: Int,
            link: String,
            encryptPendingIntent: PendingIntent
        ) {
